...
def capture(monkeypatch):
    objects = [{'Key': 'olist-v1/cdc/001.csv', 'ETag': 'first', 'Size': 100}]
    ...
    class S3:
        ...
        def paginate(self, **kwargs):
            assert kwargs == dict(Bucket='demo', Prefix='olist-v1/')
...
def test_completed_batch_skips_until_capture_changes(tmp_path, capture):
    ...
    capture.append({'Key': 'olist-v1/cdc/002.csv', 'ETag': 'second', 'Size': 80})
