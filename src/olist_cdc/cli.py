...
def main():
    ...
    parser = argparse.ArgumentParser(description="Olist CDC project commands")
    ...
    seed = sub.add_parser("seed", help="Download and load the pinned Olist sample once")
    seed.add_argument("--archive", type=Path, default=Path("data/olist/source.zip"))
    simulate = sub.add_parser("simulate", help="Commit a small, repeatable e-commerce order scenario")
